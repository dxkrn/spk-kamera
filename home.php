...
<body>
	...
	<!-- Jumbotron Start -->
	<div id="index-banner" class="parallax-container" style="height: 640px;;">
		<div class="section no-pad-bot">
			<div class="container">
				<h1 class="header jarak center white-text" style="font-size: 40px">SISTEM PENDUKUNG KEPUTUSAN PEMILIHAN KAMERA</h1>
				<div class="row center">
					<h5 class="header jarak-button col s12 light" style="margin-bottom: 0px; font-size: 26px">METODE TOPSIS</h5>
				</div>
				<div class="row center" \>
					<a href="rekomendasi.php" id="download-button" class="waves-effect waves-light btn-large" style="margin-top: 40px">Metode Topsis</a>
					<a href="metode_fuzzy.php" id="download-button" class="waves-effect waves-light btn-large" style="margin-top: 40px">Metode Fuzzy</a>
				</div>
			...
			<div class="section-card" style="padding: 36px 0px">
				<div class="row">
					<div class="col s6">
						...
						<p style="text-align: justify; padding-right: 16px;">Sistem Pendukung Keputusan Pemilihan Kamera ini menggunakan metode TOPSIS dan Fuzzy Tahani. Sistem ini dibuat sebagai Tugas Akhir Mata Kuliah Sistem Pendukung Keputusan Prodi Pendidikan Teknik Informatika Universitas Negeri Yogyakarta. </p>
					</div>
					<div class="col s6">
						<center>
						...
						<p style="text-align: justify; padding-left: 16px;">
							<b>Metode TOPSIS</b> adalah salah satu metode penyelesaian pada sistem pendukung keputusan. Metode ini mengevaluasi beberapa alternatif terhadap sekumpulan atribuat atau kriteria, dimana setiap atribut saling tidak bergantung satu dengan yang lainnya.<br>
							<b>Metode Fuzzy Tahani</b> merupakan salah satu metode fuzzy yang menggunakan basis data standar. Pada basis data standar, data diklasifikasikan berdasarkan pandangan user. Oleh karena itu, pada basis data standar data yang ditampilkan akan keluar seperti data yang telah disimpan.
						</p>
					</div>
				</div>
			</div>
