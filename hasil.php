			...
			<div class="container">
				...
				<div class="nav-wrapper">
					<ul class="left" style="margin-left: -52px;">
						...
						<li><a href="daftar_kamera.php">DAFTAR KAMERA</a></li>
	...
	<div style="background-color: #efefef">
		<div class="container">
			<div class="section-card" style="padding: 20px 0px">
				...
				<center>
					<h4 class="header" style="margin-left: 24px; margin-bottom: 0px; margin-top: 24px; color: #635c73;">HASIL REKOMENDASI KAMERA</h4>
				</center>
				<ul>
					<li>
						<div class="row">
							<div class="card">
								<div class="card-content">
									<h5 style="margin-bottom: 16px; margin-top: -6px;">Matrik Kamera</h5>
									<table class="responsive-table">
										...
										<tbody>
											...
											$no = 1;
											while ($data_kamera = mysqli_fetch_array($query)) {
												$Matrik[$no - 1] = array($data_kamera['harga_angka'], $data_kamera['res_gambar_angka'], $data_kamera['res_video_angka'], $data_kamera['iso_max_angka'], $data_kamera['shutter_max_angka']);
											?>
												<tr>
													<td>
													...
													<td>
														<center><?php echo $data_kamera['harga_angka'] ?></center>
													</td>
													<td>
														<center><?php echo $data_kamera['res_gambar_angka'] ?></center>
													</td>
													<td>
														<center><?php echo $data_kamera['res_video_angka'] ?></center>
													</td>
													<td>
														<center><?php echo $data_kamera['iso_max_angka'] ?></center>
													</td>
													<td>
														<center><?php echo $data_kamera['shutter_max_angka'] ?></center>
													</td>
												</tr>
											<?php
												$no++;
										...
										<tbody>
											...
											while ($data_kamera = mysqli_fetch_array($query)) {
												...
												$MatrikNormalisasi[$no - 1] = array(
													$data_kamera['harga_angka'] / $pembagiNM[0],
													$data_kamera['res_gambar_angka'] / $pembagiNM[1],
													$data_kamera['res_video_angka'] / $pembagiNM[2],
													$data_kamera['iso_max_angka'] / $pembagiNM[3],
													$data_kamera['shutter_max_angka'] / $pembagiNM[4]
												);
											...
											?>
												<tr>
													...
													<td>
														<center><?php echo round($data_kamera['harga_angka'] / $pembagiNM[0], 6) ?></center>
													</td>
													<td>
														<center><?php echo round($data_kamera['res_gambar_angka'] / $pembagiNM[1], 6) ?></center>
													</td>
													<td>
														<center><?php echo round($data_kamera['res_video_angka'] / $pembagiNM[2], 6) ?></center>
													</td>
													<td>
														<center><?php echo round($data_kamera['iso_max_angka'] / $pembagiNM[3], 6) ?></center>
													</td>
													<td>
														<center><?php echo round($data_kamera['shutter_max_angka'] / $pembagiNM[4], 6) ?></center>
													</td>
												</tr>
											<?php
												$no++;
									...
									<table class="responsive-table">
										<thead>
											<tr>
												...
												<th>
													<center>Value Kriteria Resolusi Gambar</center>
												</th>
												<th>
													<center>Value Kriteria Resolusi Video</center>
												</th>
												<th>
													<center>Value Kriteria ISO Max</center>
												</th>
												<th>
													<center>Value Kriteria Shutter Speed</center>
												</th>
											</tr>
										</thead>
										<tbody>
										...
										<tbody>
											<tr>
												...
												for ($i = 0; $i < count($nilaiV); $i++) {
													if ($nilaiV[$i] == $testmax) {
														$query = mysqli_query($selectdb, "SELECT * FROM data_kamera where id_kamera = $i+1");
												?>
														<td>
														...
														<?php while ($user = mysqli_fetch_array($query)) { ?>
															<td>
																<center><?php echo $user['nama_kamera']; ?></center>
															</td>
												<?php
														}
													}
